...
exports.getChatCompletion =async(prompt)=> {
    ...
    messages: [
      ...
      {
        role: "user",
        content:`isme jo text output hume mil ra hai usme kuch special character hai jese ## ** ek example **Lakshya Tanwar's Roadmap to Success**
**Personal Overview**
- **Full Name:** Lakshya Tanwar
- **Gender:** Male
- **Country:** India
- **City:** Bhopal
...
- **Current Marks:** 
 - 10th: 80%
 - 11th: 82%
- **Exam Preparation:** IIT-JE , iss type ke to inhe hatakar do clean only text in systematic way`,
      },
      {
        role: "user",
        content:`iska output bhi thek thak aya like - **Lakshya Tanwar's Roadmap to Success**
**Personal Overview**
- Full Name: Lakshya Tanwar
- Gender: Male
- Country: India
...
isme jo niche ka data hau bo to thek hai but upr wali jo heading hai **Lakshya Tanwar's Roadmap to Success**
**Personal Overview** iss type ki ye isko bhi normal karo total clean no speical character, and iss chiz ka dhyan rkhkr puraa roadmap doo and pure roadmap me ye conditon apply kro`,
      },
// {
//     role: "user",
